...
if ($result && $result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ...
    echo "<a class='btn-gold' href='{$row['apply_link']}' target='_blank' role='button'>Apply Now</a>";
    echo "</div>";
  }
} else {
...
<aside class="job-aside-collab">
  ...
  <div class="partner-grid">
    <img src="images/jobs/partner1.png" alt="Partner 1 logo">
    <img src="images/jobs/partner5.svg" alt="Partner 5 logo">
    <img src="images/jobs/partner2.png" alt="Partner 2 logo">
    <img src="images/jobs/partner3.svg" alt="Partner 3 logo">
