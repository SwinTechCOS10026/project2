...
INSERT INTO `eoi` (`EOInumber`, `job_ref`, `first_name`, `last_name`, `dob`, `gender`, `street_address`, `suburb`, `state`, `postcode`, `email`, `phone`, `skills`, `other_skills`, `status`, `application_date`) VALUES
(1, 'DEV001', 'Alice', 'Nguyen', '1995-04-22', 'Female', '12 Main St', 'Melbourne', 'VIC', '3000', 'alice.nguyen@example.com', '0412000001', NULL, 'Knows Bootstrap', 'New', '2025-05-14'),
(2, 'IT002', 'Jason', 'Chen', '1990-12-01', 'Male', '55 York Ave', 'Sydney', 'NSW', '2000', 'jason.chen@example.com', '0422000002', NULL, 'Familiar with helpdesk tools', 'Current', '2025-05-14'),
(3, 'DEV001', 'Mia', 'Patel', '2000-07-15', 'Female', '77 King St', 'Brisbane', 'QLD', '4000', 'mia.patel@example.com', '0433000003', NULL, '', 'New', '2025-05-14'),
(4, 'DEV003', 'Ethan', 'Lee', '1998-11-09', 'Male', '5 Ocean Rd', 'Perth', 'WA', '6000', 'ethan.lee@example.com', '0444000004', NULL, 'Worked on SQL reports', 'Final', '2025-05-14'),
(5, 'IT004', 'Sophia', 'Zhao', '1993-05-28', 'Female', '9 Elm Street', 'Adelaide', 'SA', '5000', 'sophia.zhao@example.com', '0455000005', NULL, '', 'New', '2025-05-14'),
(6, 'DEV001', 'Tom', 'Williams', '1988-01-10', 'Male', '321 Creek Rd', 'Hobart', 'TAS', '7000', 'tom.williams@example.com', '0466000006', NULL, 'Basic Python skills', 'Current', '2025-05-14'),
(7, 'DEV002', 'Lily', 'Tran', '1997-08-19', 'Other', '89 George St', 'Canberra', 'ACT', '2601', 'lily.tran@example.com', '0477000007', NULL, 'Can work remotely', 'New', '2025-05-14');
